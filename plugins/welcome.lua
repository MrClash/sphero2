...
local function template_add_user(base, to_username, from_username, channel_name, channel_id)
   ...
   channel_name = string.gsub(channel_name, '_', ' ') or ''
...
local function description_rules(msg, nama)
   ...
   if data[tostring(msg.to.id)] then
      ...
      local sambutan = "سلام"[..msg.from.username..](https://telegram.me/..msg.from.username..)"\nخوش اومدی به گروه '"..string.gsub(msg.to.print_name, "_", " ").."'\nشما میتوانید با دستور\nAddadmin\nصاحب ربات را به گروه خود بیاورید\n[Robot Admin](https://telegram.me/jokers)"      local text = sambutan..about..rules.."\n"
      local receiver = get_receiver(msg)
